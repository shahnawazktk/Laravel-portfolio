<nav class="fixed top-0 w-full glass-dark z-40 py-4 px-6">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            <a href="{{ route('services') }}"
                class="text-gray-300 hover:text-white font-medium transition-colors">Services</a>
            <a href="{{ route('portfolio') }}"
                class="text-gray-300 hover:text-white font-medium transition-colors">Portfolio</a>
            <a href="{{ route('skills') }}"
                class="text-gray-300 hover:text-white font-medium transition-colors">Skills</a>
    ...
    <div id="mobileMenu" class="mobile-menu fixed top-0 right-0 h-full w-64 glass-dark p-8 md:hidden">
        ...
        <div class="flex flex-col space-y-6">
            ...
            <a href="{{ route('services') }}"
                class="text-white text-lg font-medium py-2 border-b border-gray-800">Services</a>
            <a href="{{ route('portfolio') }}"
                class="text-white text-lg font-medium py-2 border-b border-gray-800">Portfolio</a>
            <a href="{{ route('skills') }}"
                class="text-white text-lg font-medium py-2 border-b border-gray-800">Skills</a>
            <a href="{{ route('contact') }}"
